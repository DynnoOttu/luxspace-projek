...
function accordion() {
    ...
    for (let index = 0; index < accordionContainer.length; index++) {
        ...
        addClass(button, "absolute block md:hidden right-0 tranform -translate-y-1/2 focus:outline-none transition duration-200 rotate-0")
        ...
        button.addEventListener("click", onClickAnccordion);
